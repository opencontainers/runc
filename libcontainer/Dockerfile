...
ENV GOPATH $GOPATH:/go/src/github.com/opencontainers/libcontainer/vendor
...
COPY . /go/src/github.com/opencontainers/libcontainer
WORKDIR /go/src/github.com/opencontainers/libcontainer
