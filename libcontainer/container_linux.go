...
// Asynchronously, when the container finished being paused the state
// is changed to PAUSED. If the Container state is PAUSED, do nothing.
...
// Checkpoint checkpoints the running container's state to disk using the
// criu(8) utility.
