...
func (l *linuxStandardInit) Init() error {
	...
	// Usually this would be done upon execve as the file descriptor
	// has CLOEXEC flag set, but (1) execve might not happen due to
	// any kind of error below; (2) in case of runc start, it spawns
	// runc init and exits, while runc init (this code) waits on fifo
